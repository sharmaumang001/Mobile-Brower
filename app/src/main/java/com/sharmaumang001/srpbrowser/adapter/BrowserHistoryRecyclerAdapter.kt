...
class BrowserHistoryRecyclerAdapter(val context: Context, private val historyEntity: List<HistoryEntity>) : RecyclerView.Adapter<BrowserHistoryRecyclerAdapter.BrowserHistoryViewHolder>() {
