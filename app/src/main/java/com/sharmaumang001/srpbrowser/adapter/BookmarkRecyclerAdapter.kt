...
class BookmarkRecyclerAdapter(val context: Context, private val bookmarkList: List<BookmarkEntity>) : RecyclerView.Adapter<BookmarkRecyclerAdapter.BookmarkViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BookmarkViewHolder, position: Int) {
        ...
        holder.delete.setOnClickListener {
            ...
            builder.setPositiveButton("Delete") { text, listener ->
